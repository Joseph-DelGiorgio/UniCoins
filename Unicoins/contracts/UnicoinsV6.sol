...
contract UNCollaboration is ERC20, Ownable, ReentrancyGuard {
    ...
    event ProjectStakeForfeited(uint256 indexed proposalId, address indexed proposer, uint256 stakingAmount);
...
function updateProjectDeliverables(uint256 proposalId, bool deliverablesMet) public {
    ...
    if (!deliverablesMet) {
        ...
        _burn(address(this), proposal.stakedAmount); // <-- Change 'stakingAmount' to 'stakedAmount'
